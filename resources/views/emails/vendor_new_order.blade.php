                                                        ...
                                                        <tr>
                                                            <td valign="top" style="padding:48px 48px 32px">
                                                                <div id="m_8980543069595058581body_content_inner"
                                                                    ...
                                                                    <p style="margin:0 0 16px">{{__("A new order was received and marked as :order_status from :username . Their order is as follows:", ['order_status' => __($data['transaction']['status']), 'username' => $user['username']])}}</p>
