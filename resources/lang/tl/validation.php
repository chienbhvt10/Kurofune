...
return [
    ...
    */
    ...
    'email' => 'Ang email ay hindi wastong email address.',
    ...
    'numeric' => 'Ang numero ng :attribute ay dapat na numero.',
    ...
    'zipcode' => 'Mangyaring bigyan ako ng wastong zip code',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        ...
        'phone' => 'Telepono',
        'email' => 'Email address',
        'active' => 'Aktibong katayuan',
        'password' => 'Password',
        'role' => 'Tungkulin ng user',
        'file_upload' => 'Pag-upload ng file',
        'en.name' => 'pangalan',
        'shipping_address.full_name' => 'Buong pangalan',
        'shipping_address.postal_code' => 'Postal code/zip',
        'shipping_address.city' => 'Bayan / Lungsod',
        'shipping_address.prefecture' => 'Prefecture',
        'shipping_address.street_address' => 'Address ng kalye',
        'shipping_address.building' => 'Gusali',
        'shipping_address.phone' => 'Telepono',
        'billing_address.full_name' => 'Buong pangalan',
        'billing_address.postal_code' => 'Postal code/zip',
        'billing_address.city' => 'Bayan / Lungsod',
        'billing_address.prefecture' => 'Prefecture',
