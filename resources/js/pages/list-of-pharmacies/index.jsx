      ...
      <div className="list_pharmacies">
        <div className="card card-list-pharmacies">
          <div className="table-responsive">
            ...
            <div className="name-vendor second">管理および運営に関する事項</div>
            <div className="vendor-wrap">
              ...
              <div className="item-info">
                要指導医薬品・第1類医薬品 第2類医薬品 指定2類医薬品 第3類医薬品
              </div>
              <div className="item-info title">
                当薬局に勤務する者の名札等による区別
              </div>
              ...
              <div className="item-info title">営業時間外における相談時間</div>
              <div className="item-info">時間外はすべて</div>

              <div className="item-info title">相談時及び緊急時の連絡先</div>
              <div className="item-info">
