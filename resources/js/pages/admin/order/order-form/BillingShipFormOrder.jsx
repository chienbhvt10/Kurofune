...
const BillingShipFormOrder = ({ className, form, typeForm, response, onFinish }) => {
  ...
  const renderErrorTranslate = (field) => {
    return validateForm?.billing_shipping?.[field].map((item) => {
      return {
        ...item,
            ...
            <Row justify="center">
              ...
              <Col span={12}>
                <InputField
                  ...
                  type={<Input className="input-field" />}
                />
                {renderErrorMessage('field_address_line_1')}
              </Col>
              <Col span={12}>
                <InputField
                ...
                />
                {renderErrorMessage('field_address_line_2')}
              </Col>
              <Col span={12}>
                <InputField
                  field="city"
              ...
              <Col span={12}>
                <SelectFieldSearch
                  ...
                  options={PREF}
                />
                {renderErrorMessage('country_region')}
              </Col>
              <Col span={12}>
                <InputField
                  field="state_county"
                  ...
                  type={<Input className="input-field" />}
                />
                {renderErrorMessage('state_county')}
              </Col>
              {typeForm === 'billing' ?
                <>
                  <Col span={12}>
